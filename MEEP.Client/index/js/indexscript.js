...
<li>
  ...
  ${eventi[i].oraInizio} - ${eventi[i].oraFine}
          ...
          <a class="btn btn-sm btn-primary m-2 text-white" href="contatti_accompagnatori.html?evento=${eventi[i].codiceEvento}" role="button" rel="nofollow" target="_blank" style="transform: translate(500px, -10px);">Partecipa</a>
